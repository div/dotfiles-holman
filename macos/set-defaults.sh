...
sudo scutil --set ComputerName "div"
sudo scutil --set HostName "div"
sudo scutil --set LocalHostName "div"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "div"
