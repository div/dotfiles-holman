...
sudo scutil --set ComputerName "kirill"
sudo scutil --set HostName "kirill"
sudo scutil --set LocalHostName "kirill"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "kirill"
...
# Do not Allow websites to ask for permission to send push notifications
